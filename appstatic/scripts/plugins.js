...
(function($) {
    ! function(t) {
        ...
        function t(t, e) {
            ...
            this.el = t, this.options = e = b({}, e), t[z] = this;
            var n = {
                group: Math.random(),
                sort: !0,
                disabled: !1,
            ...
            this.nativeDraggable = !e.forceFallback && et, r(t, "mousedown", this._onTapStart), r(t, "touchstart", this._onTapStart), r(t, "pointerdown", this._onTapStart), this.nativeDraggable && (r(t, "dragover", this), r(t, "dragenter", this)), lt.push(this._onDragOver), e.store && this.sort(e.store.get(this))
        }

        function e(t, e) {
            "clone" !== t.lastPullMode && (e = !0), x && x.state !== e && (s(x, "display", e ? "none" : ""), e || x.state && (t.options.group.revertClone ? (N.insertBefore(x, k), t._animate(C, x)) : N.insertBefore(x, C)), x.state = e)
        }
        ...
        function s(t, e, n) {
            var o = t && t.style;
            if (o) {
                if (void 0 === n) return Q.defaultView && Q.defaultView.getComputedStyle ? n = Q.defaultView.getComputedStyle(t, "") : t.currentStyle && (n = t.currentStyle), void 0 === e ? n : n[e];
        ...
        function d(t, e, n, o, i, r, a, l) {
            ...
            s.initEvent(n, !0, !0), s.to = i || e, s.from = r || e, s.item = o || e, s.clone = x, s.oldIndex = a, s.newIndex = l, e.dispatchEvent(s), c[d] && c[d].call(t, s)
        }

        function h(t, e, n, o, i, r, a, l) {
            var s, c, d = t[z],
                h = d.options.onMove;
            return (s = Q.createEvent("Event")).initEvent("move", !0, !0), s.to = e, s.from = t, s.dragged = n, s.draggedRect = o, s.related = i || e, s.relatedRect = r || e.getBoundingClientRect(), s.willInsertAfter = l, t.dispatchEvent(s), h && (c = h.call(d, s, a)), c
        }
        ...
        function v(t, e) {
            ...
            for (; t && (t = t.previousElementSibling);) "TEMPLATE" === t.nodeName.toUpperCase() || ">*" !== e && !m(t, e) || n++;
            return n
        }
        ...
        function _(t, e) {
            var n, o;
            return function() {
                void 0 === n && (n = arguments, o = this, J(function() {
        ...
        var C, S, E, x, N, k, B, Y, O, X, I, A, M, P, R, L, F, U, j, H, W = {},
            V = /\s+/g,
            q = /left|right|inline/,
            ...
            $ = G.Polymer,
            tt = !1,
            et = "draggable" in Q.createElement("div"),
            nt = function(t) {
                return !navigator.userAgent.match(/(?:Trident.*rv[ :]?11\.|msie)/i) && (t = Q.createElement("x"), t.style.cssText = "pointer-events:auto", "auto" === t.style.pointerEvents)
            }(),
            ot = !1,
            it = Math.abs,
            rt = Math.min,
            ...
            st = _(function(t, e, n) {
                if (n && e.scroll) {
                    ...
                    if (O !== n && (Y = e.scroll, O = n, X = e.scrollFn, !0 === Y)) {
                        Y = n;
                        do {
                            if (Y.offsetWidth < Y.scrollWidth || Y.offsetHeight < Y.scrollHeight) break
                        } while (Y = Y.parentNode)
                    }
                    Y && (o = Y, i = Y.getBoundingClientRect(), r = (it(i.right - u) <= d) - (it(i.left - u) <= d), a = (it(i.bottom - f) <= d) - (it(i.top - f) <= d)), r || a || (a = (g - f <= d) - (f <= d), ((r = (p - u <= d) - (u <= d)) || a) && (o = G)), W.vx === r && W.vy === a && W.el === o || (W.el = o, W.vx = r, W.vy = a, clearInterval(W.pid), o && (W.pid = setInterval(function() {
                        if (s = a ? a * h : 0, l = r ? r * h : 0, "function" == typeof X) return X.call(c, l, s, t);
                        o === G ? G.scrollTo(G.pageXOffset + l, G.pageYOffset + s) : (o.scrollTop += s, o.scrollLeft += l)
                    }, 24)))
                }
            }, 30),
            ct = function(t) {
        ...
        t.prototype = {
            ...
            _onTapStart: function(t) {
                var e, o = this,
                    ...
                    u = r.filter;
                if (y(i), !C && !(/mousedown|pointerdown/.test(l) && 0 !== t.button || r.disabled) && !h.isContentEditable && (c = n(c, r.draggable, i)) && B !== c) {
                    if (e = v(c, r.draggable), "function" == typeof u) {
                        if (u.call(this, t, c, this)) return d(o, h, "filter", c, i, i, e), void(a && t.preventDefault())
                    } else if (u && (u = u.split(",").some(function(t) {
                            if (t = n(h, t.trim(), i)) return d(o, t, "filter", c, i, i, e), !0
            ...
            _prepareDragStart: function(t, e, n, o) {
                var i, a = this,
                    ...
                    h = a.options,
                    f = s.ownerDocument;
                n && !C && n.parentNode === s && (U = t, N = s, S = (C = n).parentNode, k = C.nextSibling, B = n, L = h.group, P = o, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, C.style["will-change"] = "all", i = function() {
                    a._disableDelayedDrag(), C.draggable = a.nativeDraggable, l(C, h.chosenClass, !0), a._triggerDragStart(t, e), d(a, N, "choose", C, N, N, P)
                }, h.ignore.split(",").forEach(function(t) {
                    c(C, t.trim(), u)
                }), r(f, "mouseup", a._onDrop), r(f, "touchend", a._onDrop), r(f, "touchcancel", a._onDrop), r(f, "pointercancel", a._onDrop), r(f, "selectstart", a), h.delay ? (r(f, "mouseup", a._disableDelayedDrag), r(f, "touchend", a._disableDelayedDrag), r(f, "touchcancel", a._disableDelayedDrag), r(f, "mousemove", a._disableDelayedDrag), r(f, "touchmove", a._disableDelayedDrag), r(f, "pointermove", a._disableDelayedDrag), a._dragStartTimer = J(i, h.delay)) : i())
            },
            _disableDelayedDrag: function() {
                var t = this.el.ownerDocument;
                clearTimeout(this._dragStartTimer), a(t, "mouseup", this._disableDelayedDrag), a(t, "touchend", this._disableDelayedDrag), a(t, "touchcancel", this._disableDelayedDrag), a(t, "mousemove", this._disableDelayedDrag), a(t, "touchmove", this._disableDelayedDrag), a(t, "pointermove", this._disableDelayedDrag)
            },
            _triggerDragStart: function(t, e) {
                (e = e || ("touch" == t.pointerType ? t : null)) ? (U = {
                    ...
                    clientX: e.clientX,
                    clientY: e.clientY
                }, this._onDragStart(U, "touch")) : this.nativeDraggable ? (r(C, "dragend", this), r(N, "dragstart", this._onDragStart)) : this._onDragStart(U, !0);
                try {
            ...
            _dragStarted: function() {
                if (N && C) {
                    var e = this.options;
                    l(C, e.ghostClass, !0), l(C, e.dragClass, !1), t.active = this, d(this, N, "start", C, N, N, P)
                } else this._nulling()
            },
            _emulateDragOver: function() {
                if (j) {
                    if (this._lastX === j.clientX && this._lastY === j.clientY) return;
                    this._lastX = j.clientX, this._lastY = j.clientY, nt || s(E, "display", "none");
            ...
            _onTouchMove: function(e) {
                if (U) {
                    ...
                    if (!t.active) {
                        if (o && rt(it(r.clientX - this._lastX), it(r.clientY - this._lastY)) < o) return;
                        this._dragStarted()
                    }
                    this._appendGhost(), H = !0, j = r, s(E, "webkitTransform", c), s(E, "mozTransform", c), s(E, "msTransform", c), s(E, "transform", c), e.preventDefault()
                }
            },
            _appendGhost: function() {
                if (!E) {
                    var t, e = C.getBoundingClientRect(),
                        n = s(C),
                        o = this.options;
                    l(E = C.cloneNode(!0), o.ghostClass, !1), l(E, o.fallbackClass, !0), l(E, o.dragClass, !0), s(E, "top", e.top - Z(n.marginTop, 10)), s(E, "left", e.left - Z(n.marginLeft, 10)), s(E, "width", e.width), s(E, "height", e.height), s(E, "opacity", "0.8"), s(E, "position", "fixed"), s(E, "zIndex", "100000"), s(E, "pointerEvents", "none"), o.fallbackOnBody && Q.body.appendChild(E) || N.appendChild(E), t = E.getBoundingClientRect(), s(E, "width", 2 * e.width - t.width), s(E, "height", 2 * e.height - t.height)
                }
            },
            _onDragStart: function(t, e) {
                var n = this,
                    o = t.dataTransfer,
                    i = n.options;
                n._offUpEvents(), L.checkPull(n, n, C, t) && ((x = D(C)).draggable = !1, x.style["will-change"] = "", s(x, "display", "none"), l(x, n.options.chosenClass, !1), n._cloneId = w(function() {
                    N.insertBefore(x, C), d(n, N, "clone", C)
                })), l(C, i.dragClass, !0), e ? ("touch" === e ? (r(Q, "touchmove", n._onTouchMove), r(Q, "touchend", n._onDrop), r(Q, "touchcancel", n._onDrop), r(Q, "pointermove", n._onTouchMove), r(Q, "pointerup", n._onDrop)) : (r(Q, "mousemove", n._onTouchMove), r(Q, "mouseup", n._onDrop)), n._loopId = setInterval(n._emulateDragOver, 50)) : (o && (o.effectAllowed = "move", i.setData && i.setData.call(n, o, C)), r(Q, "drop", n), r(Q, "mouseover", n), n._dragStartId = w(n._dragStarted))
            },
            _onDragOver: function(o) {
                var i, r, a, l, c = this.el,
                    d = this.options,
                    u = d.group,
                    g = t.active,
                    v = L === u,
                    m = !1,
                    _ = d.sort;
                if (void 0 !== o.preventDefault && (o.preventDefault(), !d.dragoverBubble && o.stopPropagation()), !C.animated && (H = !0, g && !d.disabled && (v ? _ || (l = !N.contains(C)) : F === this || (g.lastPullMode = L.checkPull(this, g, C, o)) && u.checkPut(this, g, C, o)) && (void 0 === o.rootEl || o.rootEl === this.el))) {
                    if (st(o, d, this.el), ot) return;
                    if (i = n(o.target, d.draggable, c), r = C.getBoundingClientRect(), F !== this && (F = this, m = !0), l) return e(g, !0), S = N, void(x || k ? N.insertBefore(C, x || k) : _ || N.appendChild(C));
                    if (0 === c.children.length || c.children[0] === E || c === o.target && p(c, o)) {
                        if (0 !== c.children.length && c.children[0] !== E && c === o.target && (i = c.lastElementChild), i) {
                            if (i.animated) return;
                            a = i.getBoundingClientRect()
                        }
                        e(g, v), !1 !== h(N, c, C, r, i, a, o) && (C.contains(c) || (c.appendChild(C), S = c), this._animate(r, C), i && this._animate(a, i))
                    } else if (i && !i.animated && i !== C && void 0 !== i.parentNode[z]) {
                        I !== i && (I = i, A = s(i), M = s(i.parentNode));
                        ...
                        !1 !== R && (1 !== R && -1 !== R || (O = 1 === R), ot = !0, J(f, 30), e(g, v), C.contains(c) || (O && !Y ? c.appendChild(C) : i.parentNode.insertBefore(C, O ? Y : i)), S = C.parentNode, this._animate(r, C), this._animate(a, i))
                    }
                }
            },
            _animate: function(t, e) {
                ...
                if (n) {
                    ...
                    1 === t.nodeType && (t = t.getBoundingClientRect()), s(e, "transition", "none"), s(e, "transform", "translate3d(" + (t.left - o.left) + "px," + (t.top - o.top) + "px,0)"), e.offsetWidth, s(e, "transition", "all " + n + "ms"), s(e, "transform", "translate3d(0,0,0)"), clearTimeout(e.animated), e.animated = J(function() {
            ...
            _offUpEvents: function() {
                var t = this.el.ownerDocument;
                a(Q, "touchmove", this._onTouchMove), a(Q, "pointermove", this._onTouchMove), a(t, "mouseup", this._onDrop), a(t, "touchend", this._onDrop), a(t, "pointerup", this._onDrop), a(t, "touchcancel", this._onDrop), a(t, "pointercancel", this._onDrop), a(t, "selectstart", this)
            },
            _onDrop: function(e) {
                var n = this.el,
                    o = this.options;
                clearInterval(this._loopId), clearInterval(W.pid), clearTimeout(this._dragStartTimer), T(this._cloneId), T(this._dragStartId), a(Q, "mouseover", this), a(Q, "mousemove", this._onTouchMove), this.nativeDraggable && (a(Q, "drop", this), a(n, "dragstart", this._onDragStart)), this._offUpEvents(), e && (H && (e.preventDefault(), !o.dropBubble && e.stopPropagation()), E && E.parentNode && E.parentNode.removeChild(E), N !== S && "clone" === t.active.lastPullMode || x && x.parentNode && x.parentNode.removeChild(x), C && (this.nativeDraggable && a(C, "dragend", this), u(C), C.style["will-change"] = "", l(C, this.options.ghostClass, !1), l(C, this.options.chosenClass, !1), d(this, N, "unchoose", C, S, N, P), N !== S ? (R = v(C, o.draggable)) >= 0 && (d(null, S, "add", C, S, N, P, R), d(this, N, "remove", C, S, N, P, R), d(null, S, "sort", C, S, N, P, R), d(this, N, "sort", C, S, N, P, R)) : C.nextSibling !== k && (R = v(C, o.draggable)) >= 0 && (d(this, N, "update", C, S, N, P, R), d(this, N, "sort", C, S, N, P, R)), t.active && (null != R && -1 !== R || (R = P), d(this, N, "end", C, S, N, P, R), this.save()))), this._nulling()
            },
            _nulling: function() {
                N = C = S = E = k = x = B = Y = O = U = j = H = R = I = A = F = L = t.active = null, at.forEach(function(t) {
                    t.checked = !0
                }), at.length = 0
            },
            ...
            toArray: function() {
                for (var t, e = [], o = this.el.children, i = 0, r = o.length, a = this.options; i < r; i++) n(t = o[i], a.draggable, this.el) && e.push(t.getAttribute(a.dataIdAttr) || g(t));
                return e
            },
            sort: function(t) {
                var e = {},
            ...
            destroy: function() {
                var t = this.el;
                t[z] = null, a(t, "mousedown", this._onTapStart), a(t, "touchstart", this._onTapStart), a(t, "pointerdown", this._onTapStart), this.nativeDraggable && (a(t, "dragover", this), a(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function(t) {
...
(function($) {
    ! function(t, e) {
            ...
            D[t] = o, [].forEach.call(n, function(t) {
                ...
                if (n = "A" === t.tagName ? [t] : t.getElementsByTagName("a"), 0 !== (n = [].filter.call(n, function(t) {
                    ...
                    [].forEach.call(n, function(t, n) {
                        var o = function(t) {
                                t.preventDefault ? t.preventDefault() : t.returnValue = !1, s(a, e), u(n)
                            },
                            i = {
                                eventHandler: o,
                                imageElement: t
                            };
                        x(t, "click", o), a.push(i)
                    }), o.galleries.push(a)
                }
            })
        }
        ...
        function s(t, e) {
            if (M !== t) {
                for (M = t, r(e); A.firstChild;) A.removeChild(A.firstChild);
                V.length = 0;
                for (var n, o = [], a = [], i = 0; i < t.length; i++)(n = T("div")).className = "full-image", n.id = "baguette-img-" + i, V.push(n), o.push("baguetteBox-figure-" + i), a.push("baguetteBox-figcaption-" + i), A.appendChild(V[i]);
                N.setAttribute("aria-labelledby", o.join(" ")), N.setAttribute("aria-describedby", a.join(" "))
            }
        }

        function r(t) {
            t || (t = {});
            for (var e in q) Y[e] = q[e], void 0 !== t[e] && (Y[e] = t[e]);
            A.style.transition = A.style.webkitTransition = "fadeIn" === Y.animation ? "opacity .4s ease" : "slideIn" === Y.animation ? "" : "none", "auto" === Y.buttons && ("ontouchstart" in window || 1 === M.length) && (Y.buttons = !1), L.style.display = S.style.display = Y.buttons ? "" : "none";
            try {
        ...
        function u(t) {
            Y.noScrollbars && (document.documentElement.style.overflowY = "hidden", document.body.style.overflowY = "scroll"), "block" !== N.style.display && (x(document, "keydown", a), j = {
                count: 0,
                startX: null,
                startY: null
            }, m(R = t, function() {
                C(R), k(R)
            }), h(), N.style.display = "block", Y.fullScreen && d(), setTimeout(function() {
                N.className = "visible", Y.bodyClass && document.body.classList && document.body.classList.add(Y.bodyClass), Y.afterShow && Y.afterShow()
            }, 50), Y.onChange && Y.onChange(R, V.length), U = document.activeElement, c())
        }
        ...
        function g() {
            Y.noScrollbars && (document.documentElement.style.overflowY = "auto", document.body.style.overflowY = "auto"), "none" !== N.style.display && (E(document, "keydown", a), N.className = "", setTimeout(function() {
            ...
            if (void 0 !== n && void 0 !== o)
                if (n.getElementsByTagName("img")[0]) e && e();
                    ...
                    var a = o.imageElement,
                        ...
                        s = b(a),
                        r = T("figure");
                    if (r.id = "baguetteBox-figure-" + t, r.innerHTML = '<div class="baguetteBox-spinner"><div class="baguetteBox-double-bounce1"></div><div class="baguetteBox-double-bounce2"></div></div>', Y.captions && l) {
                        var u = T("figcaption");
                        u.id = "baguetteBox-figcaption-" + t, u.innerHTML = l, r.appendChild(u)
                    }
                    n.appendChild(r);
                    var c = T("img");
                    c.onload = function() {
                        var n = document.querySelector("#baguette-img-" + t + " .baguetteBox-spinner");
                        r.removeChild(n), !Y.async && e && e()
                    }, c.setAttribute("src", s), c.alt = i ? i.alt || "" : "", Y.titleTag && l && (c.title = l), r.appendChild(c), Y.async && e && e()
                }
        }
        ...
        function b(t) {
            ...
            if (t.dataset) {
                ...
                for (var a = Object.keys(n).sort(function(t, e) {
                    ...
                    }), i = window.innerWidth * window.devicePixelRatio, l = 0; l < a.length - 1 && a[l] < i;) l++;
                e = n[a[l]] || e
            }
            return e
        }
        ...
        function p() {
            var t;
            return R <= V.length - 2 ? (R++, h(), C(R), t = !0) : Y.animation && (A.className = "bounce-from-right", setTimeout(function() {
                A.className = ""
            }, 400), t = !1), Y.onChange && Y.onChange(R, V.length), t
        }

        function v() {
            var t;
            return R >= 1 ? (R--, h(), k(R), t = !0) : Y.animation && (A.className = "bounce-from-left", setTimeout(function() {
                A.className = ""
            }, 400), t = !1), Y.onChange && Y.onChange(R, V.length), t
        }
        ...
        function h() {
            ...
            "fadeIn" === Y.animation ? (A.style.opacity = 0, setTimeout(function() {
                X.transforms ? A.style.transform = A.style.webkitTransform = "translate3d(" + t + ",0,0)" : A.style.left = t, A.style.opacity = 1
        ...
        var N, A, L, S, P, F = '<i class="fa fa-angle-left"></i>',
            H = '<i class="fa fa-angle-right"></i>',
            ...
            Q = function(t) {
                ++j.count > 1 && (j.multitouch = !0), j.startX = t.changedTouches[0].pageX, j.startY = t.changedTouches[0].pageY
            },
            Z = function(t) {
                if (!O && !j.multitouch) {
                    t.preventDefault ? t.preventDefault() : t.returnValue = !1;
                    var e = t.touches[0] || t.changedTouches[0];
                    e.pageX - j.startX > 40 ? (O = !0, v()) : e.pageX - j.startX < -40 ? (O = !0, p()) : j.startY - e.pageY > 100 && g()
                }
            },
            $ = function() {
                --j.count <= 0 && (j.multitouch = !1), O = !1
            },
            _ = function() {
                $()
            },
        ...
        return [].forEach || (Array.prototype.forEach = function(t, e) {
            ...
            for (n = this, o = [], a = 0; a < n.length; a++) t.call(e, n[a], a, n) && o.push(n[a]);
            return o
        }), {
            run: function(e, a) {
                X.transforms = y(), X.svg = w(), o(), n(e), t(e, a)
            },
            showNext: p,
            showPrevious: v,
            destroy: function() {
                l(), e(), E(document, "keydown", a), document.getElementsByTagName("body")[0].removeChild(document.getElementById("baguetteBox-overlay")), D = {}, M = [], R = 0
            }
        }
    })
}(jQuery));
            ...
            var r = t("html, body"),
                ...
                u = function(i, l) {
                    ...
                    return l = t.extend({}, t.fn.smoothState.options, l), null === e.history.state ? (p = l.alterChangeState({
                        id: c
                    }, n.title, g), e.history.replaceState(p, n.title, g)) : p = {}, s.storePageIn(d, g, n.documentElement.outerHTML, c, p), s.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), x(u), {
                        href: g,
                        cache: d,
                        clear: m,
                        load: w,
